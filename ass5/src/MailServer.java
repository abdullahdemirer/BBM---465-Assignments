...
public class MailServer {
	...
	public static void connectClient() throws IOException, Exception {
		...
		Socket s = ss.accept();
		System.out.println("Connection Mail Server  established");
	...
	public static void thirdPhase() throws Exception {
		...
		writeFile(logFile,
				" Alice->Mail : " + "\"" + clientMessage[0] + "\", " + clientMessage[1] + ", " + clientMessage[2]);
	...
	public static String fourthPhase() throws Exception {
		...
		writeFile(logFile, " Mail->Alice : " + "[" + newClientNonceValue + "], " + "[" + serverNonceValue + "] ");
		...
		writeFile(logFile, " Mail->Alice : " + encryptedMessage);
	...
	public static String fifthPhase(String clientResponse) throws Exception {
		...
		writeFile(logFile, " Alice->Mail : " + clientResponse);
		...
		if (serverNonceValue + 1 != nonceValue1) {
			...
			writeFile(logFile, " Mail->Alice : " + "\"Authentication is completed!\"");
	...
	public static String decrypt(String encryptText) throws Exception {
		String privateKey = getPrivateKey("MailPrivateKey");
