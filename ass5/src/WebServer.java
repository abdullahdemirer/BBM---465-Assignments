...
public class WebServer {
	...
	public static void thirdPhase() throws Exception {
		...
		writeFile(logFile,
				" Alice->Web : " + "\"" + clientMessage[0] + "\", " + clientMessage[1] + ", " + clientMessage[2]);
	...
	public static String fourthPhase() throws Exception {
		...
		writeFile(logFile, " Web->Alice : " + "[" + newClientNonceValue + "], " + "[" + serverNonceValue + "] ");
		...
		writeFile(logFile, " Web->Alice : " + encryptedMessage);
	...
	public static String fifthPhase(String clientResponse) throws Exception {
		...
		writeFile(logFile, " Alice->Web : " + clientResponse);
		...
		if (serverNonceValue + 1 != nonceValue1) {
			...
			writeFile(logFile, " Web->Alice : " + "\"Authentication is completed!\"");
	...
	public static String decrypt(String encryptText) throws Exception {
		String privateKey = getPrivateKey("WebPrivateKey");
